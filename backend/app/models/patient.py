...
class Patient(Base):
    ...
    merged_into_id = Column(Integer, ForeignKey("patients.id"), nullable=True)  # set once this record is merged away — the surviving record is at this id; interim stopgap until ABHA (Phase 3 item 12)
