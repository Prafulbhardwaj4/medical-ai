...
STEPS = [
    ...
    {"page": "my-health", "device": "desktop", "step_order": 2,
     ...
     "title": "Your Health Overview", "description": "A quick summary of your recent visits and health info lives here.",
     "placement": "top"},
    ...
    {"page": "my-appointments", "device": "both", "step_order": 2,
     ...
     "placement": "left"},
    {"page": "my-appointments", "device": "both", "step_order": 3,
     "target_selector": "[data-tutorial-id='my-appointments-profile-btn']",
     "title": "Your Profile", "description": "Manage your account settings here, or replay this tour anytime.",
     "placement": "bottom"},
]
