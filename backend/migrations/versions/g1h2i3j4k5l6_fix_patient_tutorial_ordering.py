...
UPDATES = [
    ...
    {"page": "my-health", "device": "mobile", "target_selector": "#bn-records",
     ...
     "description": "Your test reports and medical records land here as soon as they're ready.",
     "placement": "top"},
    {"page": "my-health", "device": "mobile", "target_selector": "#hamburger-btn",
     "step_order": 4, "title": "Menu",
     "description": "Tap here to open the menu — this is where you'll find Book Appointment.",
     "placement": "bottom"},
