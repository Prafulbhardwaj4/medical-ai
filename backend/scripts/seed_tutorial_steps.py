...
STEPS = [
    ...
    {"role": "receptionist", "page": "receptionist-admissions", "device": "both", "step_order": 3,
     ...
     "description": "Toggle between Currently Admitted and History above, and tap the demo card below to see a patient's own page.",
     "placement": "top"},
